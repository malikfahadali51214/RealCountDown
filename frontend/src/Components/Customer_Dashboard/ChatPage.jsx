...
const AgentListItem = styled(({ button, selected, ...other }) => (
  <ListItem {...other} />
))(({ theme, selected }) => ({
...
const ChatPage = () => {
  ...
  const [customerRole, setCustomerRole] = useState('Buyer');
  ...
  const handleSendMessage = () => {
    if (newMessage.trim() !== '' || price.trim() !== '') {
      const updatedMessages = [
        ...messages,
        {
          text: price.trim() !== '' ? `Price confirmed: ${price}` : newMessage,
          sender: 'user',
          time: new Date(),
          reactions: {},
        },
  ...
  const handleSelectProperty = () => {
    // Redirect to property details page (replace with your routing logic)
    console.log("Redirecting to property details...");
    // You can use history.push('/property-details') if using react-router
  };
            ...
            <ChatContainer>
              ...
              <MainChatArea>
                <Header>
                  ...
                  <Box sx={{ cursor: 'pointer' }} onClick={handleSelectProperty}>
                ...
                {(customerRole === 'Seller' || customerRole === 'Renter') && (
                  <TextField
                    variant="outlined"
                    label="Set Price"
                    value={price}
